...
export class OrganizationsService {
  ...
  try {
    ...
    this.logger.log(`Organización creada: ${savedOrganization.id} - ${savedOrganization.name}`);

    await this.usersService.promoteToOrgOwner(userId, savedOrganization.id);
    this.logger.log(`Usuario ${userId} promovido a ORG_OWNER de ${savedOrganization.id}`);
